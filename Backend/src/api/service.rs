...
use actix_web::{web};
use crate::api::contactinfo::{contactinfos_create_handler, contactinfos_get_handler, contactinfos_list_handler};
...
use crate::api::person::{persons_create_handler, persons_get_handler, persons_list_handler};
